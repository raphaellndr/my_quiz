...
class _QuizPage extends State<QuizPage> {
  ...
  List<Question> questionsList = [
    ...
    Question('Le nom du drapeau des pirates est Black Skull', false, 'Il est appelé Jolly Roger', 'assets/pirate.png'),
    ...
    Question('Au Québec tire toi une bûche veut dire viens t\'asseoir', true, 'La bûche, fameuse chaise de bucheron', 'assets/buche.jpg'),
    Question('Le module lunaire Eagle ne possédait que 4Ko de Ram', true, 'Dire que je me plains avec mes 8GO de ram sur mon mac', 'assets/eagle.jpg'),
  ];
